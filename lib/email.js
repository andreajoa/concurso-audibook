...
async function sendMarketingEmail({to,subject,title,bodyHtml,ctaLabel,ctaUrl,origin,scheduledAt,campaign='apostilas',idempotencyKey}) {
  ...
  return deliver({to,subject,html:shell({eyebrow:'SALA DE ESTUDOS • MARGARETH ALMEIDA',title,body:bodyHtml,ctaLabel,ctaUrl,footer}),scheduledAt,idempotencyKey,tags:[{name:'type',value:'marketing'},{name:'campaign',value:campaign}]});
}
