...
const CSS = '<link rel="stylesheet" href="/portal-news.css?v=20260914-portal"><link rel="stylesheet" href="/portal-reset.css?v=20260914-portal">';
...
for (const file of files) {
  ...
  html = html.replace(/<link[^>]+href=["']\/portal-reset\.css[^>]*>\s*/gi, '');
